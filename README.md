...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/summarytools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/summarytools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add summarytools
# for installing globally
pixi global install summarytools
```
...
It is possible to list all of the versions of `summarytools` available on your platform:
...
```
pixi search summarytools --channel conda-forge
```
